...
/*
    Salesforce supports different types of authentication mechanisms, but for simplicity and the purpose of this project, I'm using a username and password based login.
    Added code that sets up my Express server to authenticate to my Salesforce instance.

    Read the environment variables from .env file, and use them to create an authenticated connection to my Salesforce instance. Add some code to fetch data from Salesforce.
*/
